...
public class A1063330_checkpoint6_DemoPanel extends JPanel {
    ...
    private ArrayList<A1063330_checkpoint6_Block> path;
    //Description : while moving, the target block;
    private A1063330_checkpoint6_Block target;
    public A1063330_checkpoint6_DemoPanel(A1063330_checkpoint6_Player player, ArrayList<A1063330_checkpoint6_Block> obstacle,int scaler){
        ...
        this.player = player;
        this.add(player);
        this.path = new ArrayList<A1063330_checkpoint6_Block>();
        this.target = null;
    ...
    public void paintComponent(Graphics g){
        ...
        for(A1063330_checkpoint6_Block x : obstacle){
        ...
        if(!player.getMoving()){
            ...
            g.setColor(color);
            for(A1063330_checkpoint6_Block x : path){
    ...
    public void setPath(ArrayList<A1063330_checkpoint6_Block> path){
        this.path = path;
    }
    ...
    public void setTarget(A1063330_checkpoint6_Block target){
        this.target = target;
    }
    public A1063330_checkpoint6_Block getTarget(){
        return this.target;
    }
}
